...
export async function uploadToCloudinary(
  ...
  const cloudName = process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME; // Sandbox cloud name fallback
  const uploadPreset =
    process.env.NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET || "upload_preset"; // Unsigned preset fallback
